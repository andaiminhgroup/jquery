        ...
        function loadtoc(json) {
                function getPostData() { // this functions reads all postdata from the json-feed and stores it in arrays
                        if ("entry" in json.feed) {
                            ...
                            for (var i = 0; i < numEntries; i++) { // get the entry from the feed
        ...
        function sortPosts(sortBy) {
                ...
                function swapPosts(x, y) { // Swaps 2 ToC-entries by swapping all array-elements
            ...
            // end sortPosts
            // displaying the toc
        function displayToc(filter) { // this function creates a three-column table and adds it to the screen
                var numDisplayed = 0;
                var tocTable = '';
                ...
                if (numDisplayed == postTitle.length) {
                    var tocNote = '<span class="toc-note">SITEMAP &#124; ' + postTitle.length + ' BÀI VIẾT<br/></span>';
                } else {
                    var tocNote = '<span class="toc-note">Hiển thị ' + numDisplayed + ' posts labeled \'';
